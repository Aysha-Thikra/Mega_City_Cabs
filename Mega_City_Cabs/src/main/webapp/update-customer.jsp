...
<head>
    ...
    <title>Update Customer - Mega City Cabs</title>
...
<body>
    ...
    <div class="dashboard-container">
        <div class="dashboard-header">
            <%
                ...
                try {
                    ...
                    String sql = "UPDATE users SET firstName = ?, lastName = ?, email = ?, phoneNumber = ?, address = ?, NIC = ?, username = ? WHERE userID = ?";
        ...
        <div class="form-container">
            <a href="manage-customers.jsp" class="cancel-btn">Back to Manage Customers</a>
        </div>
    </div>
</body>
</html>
