        ...
        <div class="form-wrapper">
            ...
            <form action="driver-signup" method="post" class="signup-form">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" name="phone" placeholder="Phone Number" required maxlength="12" pattern="\d{3}-\d{7}" oninput="formatPhoneNumber()">
                </div>
                <div class="form-group">
            ...
            <p class="login-link">Already have an account? <a href="driver-login.jsp">Login</a></p>
        </div>
    </div>
