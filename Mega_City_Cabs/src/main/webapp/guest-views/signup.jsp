...
<body>
    ...
    <div class="signup-container" style="margin-bottom: 104px;">
        ...
        <div class="signup-options">
            <button onclick="location.href='../admin-views/admin-signup.jsp';" class="signup-btn admin">Admin Signup</button>
            <button onclick="location.href='../customer-views/customer-signup.jsp';" class="signup-btn customer">Customer Signup</button>
            <button onclick="location.href='../driver-views/driver-signup.jsp';" class="signup-btn driver">Driver Signup</button>
        </div>
    </div>
