...
<body>
    ...
    <div class="dashboard-container">
        <div class="dashboard-header">Manage Drivers</div>
            ...
            <tbody>
                <%
                    ...
                    try {
                        ...
                        rs = stmt.executeQuery("SELECT userID, firstName, lastName, address, NIC, phoneNumber, email, licenseNumber, username FROM users WHERE userLevel = 3");
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        <a href="update-driver.jsp?userID=<%= rs.getString("userID") %>" class="edit-btn">
                            <i class="fas fa-edit"></i>
                        </a>
                        <a href="delete-driver.jsp?userID=<%= rs.getString("userID") %>" class="delete-btn" onclick="return confirm('Are you sure you want to delete this driver?');">
