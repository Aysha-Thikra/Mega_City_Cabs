...
<head>
    ...
    <title>Confirm Ride - Mega City Cabs</title>
    ...
    <div class="confirmation-container">
        <%
            ...
            try {
                ...
                String updateQuery = "UPDATE booking SET status = 'Ride Confirmed' WHERE booking_id = ?";
                pstmt = conn.prepareStatement(updateQuery);
                pstmt.setString(1, bookingId);
                int result = pstmt.executeUpdate();

                if (result > 0) {
                    out.println("<div class='confirmation-header'>Ride Confirmed</div>");
                    out.println("<div class='message'>Your ride has been successfully confirmed!</div>");
                } else {
