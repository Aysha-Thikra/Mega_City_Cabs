    ...
    <div class="profile-container">
        <div class="form-wrapper">
            ...
            <form action="update-driver-action.jsp" method="POST" class="profile-form">
                ...
                <div class="form-group"><i class="fas fa-id-badge"></i><input type="text" name="licenseNumber" value="<%= licenseNumber %>" required></div>
                <div class="form-group"><i class="fas fa-user-circle"></i><input type="text" name="username" value="<%= username %>" required></div>
                <div class="form-group"><i class="fas fa-lock"></i><input type="password" name="password" placeholder="Leave blank to keep current password"></div>
